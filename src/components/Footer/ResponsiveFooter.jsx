...
const ResponsiveFooter = () => {
    return (
        <footer className="mt-6 bg-white dark:bg-slate-900 shadow-md rounded-xl w-full p-3 md:p-4 relative">
            ...
            <div
                ...
                <p className="text-[0.9rem] text-gray-300">© 2021 All Rights Reserved to <a href="https://github.com/Anticoder03" target="_blank">@Anticoder03</a></p>
            ...
            {/* <img src="https://i.ibb.co/zNk7XT4/Rectangle-97.png" alt="background/image"
                 className="absolute bottom-[20px] sm:bottom-0 object-contain left-0 right-0 z-10 rounded-b-xl"/>
